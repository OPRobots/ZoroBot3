...
#define RIGHT_WALL_LOSS_TO_SENSING_POINT_DISTANCE 116
#define LEFT_WALL_LOSS_TO_SENSING_POINT_DISTANCE 110
...
#define SENSOR_RAW_THRESHOLD_DISTANCE_FACTOR 1.5f
