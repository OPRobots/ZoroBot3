...
#define DATA_LENGTH (MPU_DATA_LENGTH + NUM_SENSORES + NUM_SENSORES + NUM_SENSORES + NUM_WALL_LOST_DISTANCES + MAZE_CELLS + MENU_RUN_NUM_MODES + RC5_DATA_LENGTH)
...
#define DATA_INDEX_SENSORS_WALL_LOST (DATA_INDEX_SENSORS_MIDDLE_TARGET_DISTANCE + NUM_SENSORES)
#define DATA_INDEX_MAZE (DATA_INDEX_SENSORS_WALL_LOST + NUM_WALL_LOST_DISTANCES)
